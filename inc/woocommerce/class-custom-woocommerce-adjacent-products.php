<?php
/**
 * custom WooCommerce Adjacent Products Class
 *
 * @package  custom
 * @since    2.4.3
 */
...
if ( ! class_exists( 'custom_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The custom WooCommerce Adjacent Products Class
	 */
	class custom_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'custom_woocommerce_adjacent_query_args', $args ) );
