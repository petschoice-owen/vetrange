...
<header class="<?php echo esc_attr( $wrapper_classes ); ?>">
    <div class="note-bar">
        <div class="inner flex-mob a-center">
            ...
            <p class="wicon w-text discount" style="background-image: url(/wp-content/uploads/2024/05/icon-discount.png)">10% membership discount applied automatically</p>
    ...
    <div class="header-main">
        <div class="inner flex-mob a-center">
            <a href="/" class="logo">
                <img src="/wp-content/uploads/2024/05/pc-vet-division-white.png" alt="Vet Range" >
            </a>
...
<style>
    ...
    /* Contact Form 7 Newsletter - Sidebar */
    .klaviyo-sidebar-floating .sidebar-content h3 {
        font-weight: bold;
        font-size: 22px;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .newsletter-subject-wrapper {
        display: none;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .form-row-custom span {
        display: flex;
        flex-direction: column;
        margin-bottom: 0;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .form-row-custom br,
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .wpcf7-not-valid-tip,
    .klaviyo-sidebar-floating .klaviyo-sidebar .wpcf7-response-output {
        display: none !important;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 p {
        margin-bottom: 0;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 #email {
        height: 46px;
    ...
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 #email:focus,
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .wpcf7-submit:focus {
        outline: none !important;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 #email.wpcf7-not-valid {
        border: 2px solid red;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .wpcf7-submit {
        width: 100%;
        height: 46px;
        margin-top: 7px;
        font-family: Nunito-Sans-Klaviyo-Hosted, Arial, "Helvetica Neue", Helvetica, sans-serif;
    ...
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .wpcf7-submit:hover {
        color: #fff;
        background-color: #92c4d0;
    }
    .klaviyo-sidebar-floating .klaviyo-sidebar .newsletter-cf7 .form-row-custom .wpcf7-spinner {
        position: absolute;
        bottom: 5px;
        right: 0;
        left: 0;
    ...
    .klaviyo-sidebar-floating .sidebar-content .cf7-message {
        position: absolute;
        top: 100%;
        left: 0;
        width: 100%;
    ...
    .klaviyo-sidebar-floating .sidebar-content .cf7-message::after {
        content: "";
        position: absolute;
        bottom: 0;
        left: 100%;
...
<script>
    ...
    var wpcf7Elm = document.querySelector('.klaviyo-sidebar .wpcf7');
    wpcf7Elm.addEventListener('wpcf7mailsent', function(event) {
        $('<p class="cf7-message">Thank you for subscribing.</p>').insertAfter('.sidebar-content .klaviyo-sidebar');
        setTimeout(() => {
            $('.klaviyo-sidebar-floating .cf7-message').fadeOut();
        }, 3000);
        setTimeout(() => {
            $('.klaviyo-sidebar-floating .cf7-message').remove();
        }, 3500);
        $('.klaviyo-sidebar-floating .sidebar-text').click(function(e) {
            $('.klaviyo-sidebar-floating .cf7-message').fadeOut();
            setTimeout(() => {
